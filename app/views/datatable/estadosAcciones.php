    ...
    <div class="row">
        ...
        <div class="text-center">
            ...
            <div class="table-responsive">
                <table id="table_esAcciones" class="table table-striped table-bordered" style="width:100%">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <center>
                    <h4 class="modal-title" id="myModalLabel">Agregar Estado Accion</h4>
                </center>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="EstadosAcciones/agregarEstadoAccion">
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col-sm-5">
                            <label class="control-label" style="position:relative; top:7px;">Estado Accion:</label>
                        </div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="estadoAccion">
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="ModalEdit" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <center>
                    <h4 class="modal-title" id="myModalLabel">Editar Estado Accion</h4>
                </center>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <form method="POST"  action="EstadosAcciones/actualizarEstadoAccion">
                <div class="modal-body">
                    <div class="container-fluid">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <center>
                    <h4 class="modal-title" id="myModalLabel">Borrar Estado Accion</h4>
                </center>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <form method="POST"  action="EstadosAcciones/borrarEstadoAccion">
