<?php
//require_once 'core/model/tables/conectarDT.php';
include_once('conectarDT.php');
/*
...
class SSP extends ConectarDT {
	...
	{
		$limit = '';
	//	echo 'LENGTHSSS '.json_encode($request);
...
//		echo '<script>console.log(Data ok);</script>';
	...
	//	echo 'QUERY:</br> '.$sql.'***************</br>';
		...
		// Return all
	//	echo 'RESULT:</br> '.json_encode($stmt->fetchAll( PDO::FETCH_BOTH )).'***************</br>'; return;
